...
from . import generators, getters
...
class A:
    ...
    def __init__(
        self, number: int, json: typing.Optional[typing.Dict[str, typing.Any]] = None
    ):
    ...
    def get(self, index: int) -> int:
        ...
        if index < self.offset:
            raise IndexError(
                INDEX_TOO_SMALL_MSG.format(idx=index, offset=self.offset, repr_=repr_)
            )
